...
## Installation
To install the [sonoptix_ros2]((https://github.com/itskalvik/sonoptix_ros2) ) package, clone this repository into your ROS 2 workspace and build it using `colcon`:
...
```bash
ros2 launch sonoptix_ros2 decompress.launch.py
```
...
**Run Example**:
```bash
ros2 run sonoptix_ros2 echo_imager --ros-args -p contrast:=10 -p data_topic:=/sonar/echo/data
```
